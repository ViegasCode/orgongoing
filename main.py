...
def organograma():
    ...
    # Se a tabela já estiver criada, vamos garantir que só insira se estiver vazia
    ...
    if c.fetchone()[0] == 0:
        ...
        c.executemany("INSERT INTO pessoas (id,nome,sobrenome,cargo,setor,lider_id) VALUES (?,?,?,?,?,?)", pessoas)
        conn.commit()
